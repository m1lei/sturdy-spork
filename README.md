<p>Слайдер в некоторый моментах может не работать и некоторые css классы</p>
...
Чтобы увидеть полный функционал для начало следует добавить хотя бы по одной записи в каждую Screen, через /admin 
<p>Для работы слайдера понадобиться 3-4 записи модели слайдера</p>
